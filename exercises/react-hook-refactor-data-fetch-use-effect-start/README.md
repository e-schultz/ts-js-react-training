# React Hooks - Refactor Exercise - useEffect -  Solution

This exercise is based on one of the previous data-fetch examples.

* Modify `src/components/HackerNewsSearch.js` to use the `useEffect` hook instead of being a component that extends from `React.Component`

* Extra: 
  * Extract the functionality into a custom hook called `useHackerNewsSearch`
  * Refactor `src/App.js` to be a functional component and use `useState`
