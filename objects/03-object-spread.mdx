...
* I think a simpler example might be better to start with
...
* Worth mentioning here that this is property-order sensitive and `year` will be overwritten if first?
