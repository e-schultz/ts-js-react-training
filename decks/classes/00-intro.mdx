...
<CodeSurfer
  ...
  steps={[
    ...
    {notes: 'Lets explore this in a repl....'}
  ]}
/>
---
...
<ReplIt src="https://repl.it/@e_schultz/Classes-SubClass-starting-point?lite=true"/>

```notes
- Generally should avoid it
- Keep the hirearchy shallow 
- talk about prototype vs other inheritance?
```
...
* Usually for framework specific 
