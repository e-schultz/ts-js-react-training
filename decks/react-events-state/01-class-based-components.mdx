...
<CodeSandbox src={`https://codesandbox.io/s/github/e-schultz/ts-js-react-training/tree/${BRANCH_NAME}/examples/react-class-state-event-examples?codemirror=1&fontsize=14&initialpath=cascading-dropdown-02&module=%2Fsrc%2Fexamples%2Fcascading-dropdown%2FCascadingDropdownExample02.js`} runOnClick={0} />
