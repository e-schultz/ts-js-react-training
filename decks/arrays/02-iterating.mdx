...
let getTotalCost = items => items.reduce((sum, cartItem) => sum + cartItem.cost, 0);
...
<CodeSandbox src="https://codesandbox.io/embed/8o39or0n0?codemirror=1&fontsize=14&module=%2Fsrc%2Findex.js" runOnClick={0}/>
