...
## Arrays - Exercise - Mapping - Start

<ReplIt src="https://repl.it/@e_schultz/Arrays-Mapping-Start?lite=true" />

---

export default FullScreenCode;

## Arrays - Exercise - Mapping - Solution

<ReplIt src="https://repl.it/@e_schultz/Arrays-Mapping-Solution?lite=true" />
