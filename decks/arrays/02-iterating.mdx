...
- Implement jobTitles.find to get the department name
- Implement filter to remove robots that are retired
- extra: filter the list to remove all inactive robots
...
<CodeSandbox
  src="https://codesandbox.io/embed/hidden-leftpad-xezhd?fontsize=14&hidenavigation=1&module=%2Fsrc%2Frobot-factory.js&theme=dark"
  runOnClick={0}
/>
...
## Exercise - Find & Filter - Solution

<CodeSandbox
  src="https://codesandbox.io/embed/robot-find-and-filter-n2jdn?fontsize=14&hidenavigation=1&module=%2Fsrc%2Frobot-factory.js&theme=dark"
  runOnClick={0}
/>
...
## Arrays - Map - Transform Data Example
...
## Exercise - Arrays - Map - Start

<ReplIt src="https://repl.it/@e_schultz/Arrays-Map-ex-start?lite=true" />

---

export default FullScreenCode;

## Exercise - Arrays - Map - Solution

<ReplIt src="https://repl.it/@e_schultz/Arrays-Map-ex-sln?lite=true" />
...
<CodeSandbox
  src={`https://codesandbox.io/embed/q7pj104wmq?codemirror=1&fontsize=14&moduleview=1`}
  runOnClick={0}
/>
...
let getTotalCost = items =>
  items.reduce((sum, cartItem) => sum + cartItem.cost, 0);
...
<CodeSandbox
  src="https://codesandbox.io/embed/8o39or0n0?codemirror=1&fontsize=14&module=%2Fsrc%2Findex.js"
  runOnClick={0}
/>
